    ...
    <div>
        <section id="About_" className="py-5">
            <div className="container-fluid">
                ...
                <p className="lead px-2">Start your journey to becoming a more disciplined and successful trader by leveraging the powerful features of our intuitive platform designed to help you track, analyze, and optimize your trades like never before. Log your trades seamlessly, monitor performance trends, and gain valuable insights with customizable charts and metrics. Whether you're a seasoned pro or just starting out, MyTradeJournal stands as your reliable ally on your journey to trading triumph.</p>
