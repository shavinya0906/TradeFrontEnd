  ...
  return (
    <div>
      <section className="reviews-responsive">
        ...
        <h1 className="term">
          <span id="startclr">Start Trading</span> on Your Terms
        </h1>
        <div className="container small-constainer">
          <div className="row">
            <div className="col-md-3">
              <div className="row">
                <div
                  className="col-md-5 big-circle"
            ...
            <div className="col-md-3" style={{ cursor: "pointer" }}>
              <div className="row">
                ...
                <div className="col-md-5 small-circle-res">
                  <div className="circle_small-res">
                    <i className="bi bi-arrow-down-short" />
                  </div>
                </div>
              </div>
          ...
          >
            <img src={yt} onClick={openYouTubeVideo} /> &nbsp;&nbsp;
            <span style={{ fontSize: 22 }} onClick={openYouTubeVideo}>
              How to Trade ?
            </span>
          </div>
        </div>
